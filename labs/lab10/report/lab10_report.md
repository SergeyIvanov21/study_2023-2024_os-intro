...
Нажимаю i, чтобы начать редактирование и добавлять текст (режим добавления), далее добавляю текст (рис. 2).
...
В режиме добавления (клавиша i) перехожу в конец последней строки и добавляю новую строку, снова перехожу в командный режим с помощью esc. После этого возвращаюсь в режим добавления, удаляю строку и возвращаюсь в командный режим. (рис. 10)

![Редактирование файла](image/10.png){#fig:010 width=70%}

В командном режиме нажимаю "u" и отменяю последнее действие, удаление строки (рис. 11).

![Отмена последнего действия](image/11.png){#fig:011 width=70%}

Перехожу в режим последней строки и ввожу w для сохранения файла и q для выхода, нажимаю enter и файл закрылся (рис. 12).
...
![Граф взаимосвязи режимов работы редактора vi](image/13.jpg){#fig:013 width=70%}
